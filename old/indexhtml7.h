// added stream auto-reconnect, dynamic labels for sliders, joystick movement 2
// Joystick zwar rechts, aber nicht über dem Bild
...
function updateJoystickMode() {
  ...
  if (!overlayActive) {
    ...
    const imageHeight = photo.clientHeight || 480;
